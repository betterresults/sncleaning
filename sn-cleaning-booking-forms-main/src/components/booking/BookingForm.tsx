...
const BookingForm: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <header className="bg-white py-4 mb-3 shadow-[0_4px_20px_rgba(0,0,0,0.25)]">
      ...
      <main className="container mx-auto px-4 py-2 max-w-[1400px]">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <Card className="p-8 bg-white transition-shadow duration-300 shadow-[0_8px_30px_rgba(0,0,0,0.3)]">
              {renderStep()}
            </Card>
          </div>
