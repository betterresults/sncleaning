        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          ...
          >
            <div className="flex flex-col items-center justify-center h-full">
              ...
              <span className={`text-sm font-bold transition-colors ${
                (data.propertyFeatures.separateKitchen || data.propertyFeatures.livingRoom) ? 'text-primary' : 'text-foreground group-hover:text-primary'
          ...
          >
            <div className="flex flex-col items-center justify-center h-full">
              <div className="text-2xl mb-2">🍽️</div>
              <span className={`text-sm font-bold transition-colors ${
                data.propertyFeatures.diningRoom ? 'text-primary' : 'text-foreground group-hover:text-primary'
              }`}>Dining Room</span>
            </div>
          </button>
