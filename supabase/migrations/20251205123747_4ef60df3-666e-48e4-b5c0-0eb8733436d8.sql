-- Fix send_booking_notification function to include postcode variable
CREATE OR REPLACE FUNCTION send_booking_notification(booking_id BIGINT, event_type TEXT)
RETURNS VOID
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
