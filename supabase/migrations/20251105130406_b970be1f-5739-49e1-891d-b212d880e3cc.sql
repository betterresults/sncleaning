-- Create email template for payment authorization failure
INSERT INTO public.email_notification_templates (
  ...
  'Action Required: Payment Authorization Failed for Your Booking',
  '<!DOCTYPE html>
<html>
<head>
  <style>
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="warning">
        <h3>⏰ Action Required Within 24 Hours</h3>
        <p>To ensure your booking is not cancelled, please update your payment information as soon as possible. We need to successfully authorize payment at least 24 hours before your scheduled service.</p>
      </div>
      ...
      <center>
        <a href="https://dkomihipebixlegygnoy.supabase.co/dashboard" class="action-button">Update Payment Method</a>
      </center>
  ...
  'Sent to customers when payment authorization fails 24 hours before their booking',
  '["customer_name", "booking_date", "booking_time", "service_type", "address", "total_cost", "booking_id", "error_message"]',
  true
);

-- Create notification trigger for authorization failure
INSERT INTO public.notification_triggers (
  ...
  (SELECT id FROM public.email_notification_templates WHERE name = 'Payment Authorization Failed' LIMIT 1),
