-- Update the send_booking_notification function to format service types better and get cleaner names from the correct table
CREATE OR REPLACE FUNCTION public.send_booking_notification(booking_id integer, event_type text)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
