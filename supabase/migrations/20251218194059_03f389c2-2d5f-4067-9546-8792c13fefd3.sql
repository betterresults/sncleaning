-- Insert a new email template for "Complete Your Booking" link
INSERT INTO email_notification_templates (
  ...
  gen_random_uuid(),
  'complete_booking_link',
  'Complete Your Booking - {{service_type}} Cleaning Quote',
  '<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
To complete your booking, visit: {{booking_url}}

If you have any questions, please don''t hesitate to contact us.

SN Cleaning Services',
  'Email sent to customers with a link to complete their booking after receiving a quote from admin',
  true,
  '["customer_name", "service_type", "total_cost", "estimated_hours", "postcode", "booking_url"]'::jsonb
);