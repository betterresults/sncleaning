...
DROP FUNCTION IF EXISTS update_inventory_on_booking_completion() CASCADE;
DROP FUNCTION IF EXISTS update_inventory_on_linen_pickup() CASCADE;

-- Recreate function to update inventory when booking is completed with proper security
...
-- Recreate function to update inventory when linen order is picked up with proper security
...
-- Recreate triggers for both functions
