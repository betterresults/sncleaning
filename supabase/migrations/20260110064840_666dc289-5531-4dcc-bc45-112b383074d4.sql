-- Fix the generate_recurring_bookings function to handle hours as TEXT type
...
BEGIN
  ...
  FOR rec IN 
    ...
    LEFT JOIN public.addresses a ON rs.address = a.address
        ...
        WHILE next_booking_date <= end_date LOOP
          ...
          IF NOT EXISTS (
            ...
            WHERE recurring_group_id = rec.recurring_group_id 
              AND date_only = next_booking_date::TEXT
          ) THEN
            INSERT INTO public.bookings (
              ...
              rec.customer, rec.cleaner, rec.address, rec.address_postcode,
              booking_datetime, next_booking_date::TEXT, rec.start_time,
              service_hours, rec.total_cost, rec.cleaning_type, rec.frequently,
              'upcoming', rec.first_name, rec.last_name, rec.email, c.phone,
