-- Update payment authorization failed email template with immediate action required
UPDATE email_notification_templates
SET 
  subject = 'Immediate Action Required: Payment Authorization Failed for Your Booking',
