...
<head>
    ...
    <link rel="stylesheet" href="<?php echo esc_url( plugins_url('../assets/style.css', __FILE__) ); ?>">
    <style>
        ...
        <div class="flex items-center justify-between h-16 lg:h-20">
            ...
            <a href="<?php echo esc_url(home_url('/')); ?>" 
               class="flex items-center hover:opacity-90 transition-all duration-300">
                <img src="<?php echo esc_url( plugins_url('../assets/sn-cleaning-logo-new.png', __FILE__) ); ?>" 
