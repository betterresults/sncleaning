...
const CleanerMessages = () => {
  ...
  const [newChatType, setNewChatType] = useState<ChatType>('office_cleaner');
  ...
  const handleCreateChat = async () => {
    ...
    if (newChatType === 'office_cleaner') {
      await createChat('office_cleaner', undefined, cleanerId);
    }
    // For customer_cleaner chats, we'll need to select a customer from assigned bookings
                ...
                <div className="flex items-center justify-center h-full bg-card">
                  <div className="text-center">
                    ...
                    <p className="text-muted-foreground mb-4">
                      Select a conversation or start a new one to communicate with customers and the office
                    </p>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Select value={newChatType} onValueChange={(value: ChatType) => setNewChatType(value)}>
                ...
                <SelectContent>
                  <SelectItem value="office_cleaner">SN Cleaning Office</SelectItem>
                </SelectContent>
              </Select>
            </div>
