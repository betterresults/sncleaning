...
>(({ className, children, fullScreen, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        fullScreen
          ? "fixed inset-0 z-50 w-full h-[100dvh] max-w-none p-0 border-none shadow-none rounded-none overscroll-contain pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0"
