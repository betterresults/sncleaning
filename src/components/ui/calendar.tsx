    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-12 w-full p-0 font-medium text-base aria-selected:opacity-100 hover:bg-accent hover:text-accent-foreground rounded-xl"
        ),
        ...
        day_today: "border-2 border-primary text-primary font-bold bg-transparent",
        day_outside:
